...
public class UserController {
	...
	public ResponseEntity<User> updateAdmin(@RequestBody User user) throws ResourceNotFoundException{
		Integer id=user.getUserId();
		if(userService.findIfIdPresent(id)){
			user.setPassword(this.bCryptPasswordEncoder.encode(user.getPassword()));
			user.setRole("ADMIN");
	...
	public ResponseEntity<String> deleteUserById(@PathVariable int userId) throws ResourceNotFoundException{
